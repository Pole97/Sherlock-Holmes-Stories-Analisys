...
<h4> Short summary of the novels:\n </h4>
...
ggplot(frequency, aes(y = `A Study in Scarlet`, x = `The Hound of the Baskervilles`)) +
  geom_abline(color = "gray40", lty = 2) +
  geom_text(aes(label = word), check_overlap = TRUE, vjust = 1.5) +
  scale_x_log10(labels = percent_format()) +
  scale_y_log10(labels = percent_format()) +
  labs(y = "A Study in Scarlet", x = "The Hound of the Baskervilles") +
  theme_light()
